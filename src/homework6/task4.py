...
# На первом курсе по высшей математике было 5.
# Результат задачи демонстрирует способности использования интернет-рессурсов
...
class Problem:
    ...
    def __init__(self, input_number):
        self.primes = None
        self._init_primes(input_number)
